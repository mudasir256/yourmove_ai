...
import Cassidy from "../assets/images/cassidy.png"
import Reese from "../assets/images/reese.png"
import ReeseFull from "../assets/images/reese_full.png"
            ...
            <div className="flex-1 px-2 overflow-y-scroll">
              ...
              {!planBeingPurchased &&
                <div className="bg-[#E85E5C] py-6 px-4 mt-10">
                  ...
                  <div
                    className="w-full border-black border-2 rounded-3xl p-6 bg-white flex flex-col gap-y-4 my-4"
                  >
                    <div className="flex gap-x-4">
                      <div className="size-12">
                        <img src={Cassidy} alt="profile" className="rounded-full w-12 h-12" />
                      </div>

                      <div className="flex flex-col">
                        <span className="font-bold text-xl">Cassidy</span>
                        ...
                        <div className="flex items-center gap-x-1">
                          ...
                          >
                            <path
                              d="M8 0.5L10.3511 5.26393L15.6085 6.02786L11.8042 9.73607L12.7023 14.9721L8 12.5L3.29772 14.9721L4.19577 9.73607L0.391548 6.02786L5.64886 5.26393L8 0.5Z"
                              fill="#F7D34C"
                            />
                          </svg>
                    ...
                    <div>
                      I had it re-vamp my photos and bio and the very next day, my number of
                      quality matches doubled!
                    </div>
                  </div>
                  ...
                  >
                    <div className="flex gap-x-4">
                      ...
                      <div className="flex flex-col">
                        <span className="font-bold text-xl">Reese</span>
                    ...
                    <div>
                      "I've always been pretty shy and struggled when it came to dating. But
                      after having this AI tool tweak my dating profile photos, I felt a lot
                      more confident putting myself out there.
                    </div>
                  ...
                  <div
                    className="w-full border-black border-2 rounded-3xl p-6 bg-white flex flex-col gap-y-4 mt-4"
                  >
                    <div className="flex gap-x-4">
                      <div className="size-12">
                        <img src={Dakota} alt="profile" className="rounded-full w-12 h-12" />
                      </div>

                      <div className="flex flex-col">
                        <span className="font-bold text-xl">Dakota</span>
                    ...
                    <div>
                      My photos were not doing me any favors on dating sites - they felt
                      awkward and just boring. This brilliant AI completely transformed them
                      to highlight my best self while still feeling totally authentic to who
                      I am.
                    </div>
                  </div>
                </div>
